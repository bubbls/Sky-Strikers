Shader "Moon/0Simple/Player/Bat_Champion" {
	Properties {
		[HideInInspector] _AlphaCutoff ("Alpha Cutoff ", Range(0, 1)) = 0.5
		[SingleLineTexture] _MainTexAEmassionMask ("MainTexA:EmassionMask", 2D) = "white" {}
		...
		[SingleLineTexture] _FontTexture ("FontTexture", 2D) = "white" {}
		[HDR] _FontColor ("FontColor", Vector) = (0,1,0.8317747,0)
		_FontTilingSpeed ("FontTilingSpeed", Vector) = (1,1,0,0)
