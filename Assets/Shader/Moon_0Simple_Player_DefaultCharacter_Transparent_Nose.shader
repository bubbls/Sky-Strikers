Shader "Moon/0Simple/Player/DefaultCharacter_Transparent_Nose" {
	Properties {
		...
		_NoseFrequency ("NoseFrequency", Float) = 0
		_NoseSpeed ("NoseSpeed", Float) = 0.5
		_NoseColor1 ("NoseColor1", Vector) = (1,1,1,0)
		[ASEEnd] _NoseColor2 ("NoseColor2", Vector) = (0,0,0,0)
