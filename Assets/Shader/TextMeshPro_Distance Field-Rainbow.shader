Shader "TextMeshPro/Distance Field-Rainbow" {
	Properties {
		...
		[SingleLineTexture] _Cube ("Reflection Cubemap", Cube) = "black" {}
		...
		[SingleLineTexture] _MainTex ("Font Atlas", 2D) = "white" {}
		...
		[Header(Rainbow)] [SingleLineTexture] _RainbowTexture ("RainbowTexture", 2D) = "white" {}
		_RainbowTiling ("RainbowTiling", Float) = 1
		_RainbowBevel ("RainbowBevel", Range(-1, 1)) = 0.1
		_RainbowSpeed ("RainbowSpeed", Float) = 0.1
	}
